...
// ← NUEVO: foto separada del resto del perfil
router.put('/mi-perfil/foto', verifyToken, requireRole([3]),
  upload.single('foto_perfil_url'),
  docenteController.updateMiFoto
);

// foto_perfil_url ya no va aquí — tiene su propia ruta arriba
