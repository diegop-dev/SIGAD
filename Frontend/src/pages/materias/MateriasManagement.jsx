        ...
        <div className="flex flex-wrap sm:flex-nowrap gap-4">
          ...
          >
            ...
            {uniqueCarreras.map(m => {
              // Extraer el código único de la carrera del código de la materia (Ej. ING-L)
                  ...
                  <tr key={m.id_materia} className="hover:bg-blue-50/50 transition-colors duration-150">
                    <td className="px-6 py-4 min-w-[250px] max-w-[350px] whitespace-normal align-middle">
                      <div className="flex flex-col">
                        <span className="text-sm font-bold text-slate-900 break-words leading-snug">
                          {m.nombre}
                        </span>
                        
                        {/* CÓDIGO ÚNICO */}
                        <div className="flex items-center mt-1.5 text-xs font-medium text-slate-500">
                          <Hash className="w-3 h-3 mr-1" />
                          {m.codigo_unico}
                        </div>
                        
                        {/* INSIGNIA DE NIVEL ACADÉMICO MOVIDA HACIA ABAJO */}
                        <div className="mt-1.5 flex items-center">
                          <span className={`px-2 py-0.5 rounded-md font-bold text-[10px] ${m.nivel_academico === 'MAESTRIA' ? 'bg-amber-100 text-amber-700' : 'bg-blue-100 text-blue-700'}`}>
                    ...
                    <td className="px-6 py-4 min-w-[250px] max-w-[350px] whitespace-normal align-middle">
                      <div className="flex flex-col">
                        <span className="text-sm font-medium text-slate-700 flex items-start break-words leading-snug">
